...
const TABLE_QUERIES = {
  users: "SELECT id,mobile_enc,mobile_sign,state,name,auth_time,portrait,blacklist_flag,create_time,modify_time FROM loan_user WHERE is_del = 0 ORDER BY create_time DESC",
